...
//        }
    ...
    private void initComponents() {
        ...
        cbxTipoProyectil.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Naval", "Terrestre", "Aereo" }));
        ...
        cbxTipoCanon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Campo", "Maritimo", "Balistico" }));
